# Trademark — "The Champagne Method"

Isolated working folder for trademark research and (possibly) a USPTO filing.
**Not part of the website build** — nothing in `trademark/` is published to the site;
GitHub Pages serves only `docs/`. Tracked in this repo by owner decision (2026-08-24),
overriding the docs-only doctrine for this folder.
